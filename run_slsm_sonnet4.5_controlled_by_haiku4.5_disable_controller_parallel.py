# run_slsm_sonnet4.5_controlled_by_haiku4.5_disable_controller_parallel.py
import json
import os
import asyncio
...
OUTPUT_FILE = "data/final_model_responses/sonnet-4.5_slsm-haiku-4.5_disable_controller.jsonl"
